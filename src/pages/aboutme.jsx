            ...
            <main className={styles.mainContainer}>
                <section className={styles.text}>
                    ...
                    <p className={styles.supportingText}>
                        I am a passionate programmer and web designer. I started programming at the end of 2018. I am a perfectionist, I try very hard to take care of the details of my works. I am not afraid to take on new challenges!
                    </p>
                </section>
                ...
                <section className={styles.waysToContactMe}>
                    ...
                    <div className={styles.aboutMeLinks}>
                        <a className={styles.aboutMeLink} href={"https://www.linkedin.com/in/artur-rok-800360249/"}>
