...
const Header = () => {
	...
	const hamburgerAnimationOpen = () => {
		if (!reduceMotion) {
			gsap.fromTo('#hamburgerNavLink', {
				translateX: '-=100',
			}, {
				translateX: '0', duration: .3, ease: 'back', stagger: .2,
			})

			gsap.to('#hamburgerIconStroke1', {
				x: '-=2', y: '+=6', width: '+=4', rotate: '45deg', duration: .3, ease: 'back',
			})

			gsap.to('#hamburgerIconStroke2', {
				x: '-=2', width: '+=4', rotate: '-45deg', duration: .3, ease: 'back',
			})

			gsap.to('#hamburgerIconStroke3', {
				x: '+=20', autoAlpha: 0, duration: .3, ease: 'back',
			})
		}
	}
	...
	const hamburgerAnimationClose = () => {
		if (!reduceMotion) {
			gsap.fromTo('#hamburgerNavLink', {
				...
				translateX: 0, duration: .2, ease: 'back', stagger: .1,
			})

			gsap.to('#hamburgerIconStroke1', { width: 16, x: 0, y: 0, rotate: 0, autoAlpha: 1, duration: .3, ease: 'back' })

			gsap.to('#hamburgerIconStroke2', { width: 16, x: 0, y: 0, rotate: 0, autoAlpha: 1, duration: .3, ease: 'back' })

			gsap.to('#hamburgerIconStroke3', { width: 9, x: 0, y: 0, rotate: 0, autoAlpha: 1, duration: .3, ease: 'back' })
		}
	}

	return size[0] > 500 ? <header className={styles.main}>
	...
	</header> : <header className={styles.componentHamburger}>
